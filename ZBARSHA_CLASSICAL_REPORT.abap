					CLASSICAL REPORT PROGRAMMING USING MULTIPLE SELECT QUERY AND JOIN CONDITION
					---------------------------------------------------------------------------

REPORT zbarsha_material_stock.
...
SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-001.
  ...
  PARAMETERS : r_r1 RADIOBUTTON GROUP grp, "Different Select Query
...
FORM display_data .
  ...
  IF r_r1 IS NOT INITIAL.
    ...
    LOOP AT gt_marc INTO gs_marc.
      AT FIRST.
        WRITE :/2 'Material Code', 20 'Material Description', 50 'Valuation area', 70 'Total Stock', 90 'Value of the stock'.
        ULINE.
      ENDAT.
